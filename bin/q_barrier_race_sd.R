...
plot_deviation_subset <- function(df, global_baseline, is_list_element = TRUE) {
  ...
  stats_subtitle <- paste0(
    "Centered on County Mean Likert Score: ", round(global_baseline, 2), 
  ...
  clean_filename <- paste0("./doc/q_barrier_race_sd_", file_suffix, "_deviation_with_stats_no_infl.png")
